const CACHE = 'vajehyar-v2.2.0';
const CORE = [
  './',
  './index.html',
  './styles-v2.2.css?release=2.2.0',
  './bootstrap-v2.2.js?release=2.2.0',
  './app-v2.2.js?release=2.2.0',
  './manifest.webmanifest?release=2.2.0',
  './icons/icon-192.png',
  './icons/icon-512.png'
];
...
self.addEventListener('fetch', event => {
  ...
  const isCode = /(?:app-v2\.2|bootstrap-v2\.2|styles-v2\.2|manifest\.webmanifest)/.test(url.pathname);
  if (isCode) {
